...
//	
	...
	public void throwObj (double towardX, double towardY, double speed) {
		double ang = Math.atan2(towardY - (this.getCenterY()), towardX - (this.getCenterX()));
...
//	}
	...
	public void setSprite (Sprite sprite) {
		...
		if (this.getSprite() == null || !this.getSprite().equals(sprite)) {
